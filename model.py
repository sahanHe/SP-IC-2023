...
def VGG16(img_input, dropout=False, with_CPFE=False, with_CA=False, with_SA=False, droup_rate=0.3):
    # Block 0
    x= Conv2D(128,(9,9),activation='relu', padding='valid', name='block0_conv1',strides=(9, 9))(img_input)
    x = Conv2D(64, (3, 3), activation='relu', padding='same', name='block0_conv2')(x)
    x = Conv2D(32, (3, 3), activation='relu', padding='same', name='block0_conv3')(x)
    x = Conv2D(32, (2, 2),strides=(2, 2), activation='relu', padding='same', name='block0_conv4')(x)
    x = Conv2D(3, (1, 1), activation='relu', padding='same', name='block0_conv5')(x)
    FEE=x
